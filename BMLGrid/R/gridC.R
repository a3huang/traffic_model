#' Creates a BML grid (new version)
#' 
#' @param r Number of rows
#' @param c Number of columns
#' @param ncars Vector of length 2 where first component is the number of red cars and second component in the number of blue cars
#' @return BML grid
#' @examples
#' createBMLGrid(10,10,c(30,40))
...
#' Takes an existing BML grid and moves the cars according to specified number of steps (new version)
#'
#'@param a BML grid
